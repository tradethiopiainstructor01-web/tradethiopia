...
const AssetDetailDrawer = ({ isOpen, onClose, selectedAsset, setSelectedAsset, handleUpdateAsset, readOnly = false }) => {
        ...
        <DrawerBody>
          {selectedAsset && (
            <VStack spacing={4} align="stretch">
              ...
              <Box p={4} borderWidth={1} borderRadius="md" bg={detailBoxBg}>
                <HStack spacing={2}>
                  <MdInfo />
