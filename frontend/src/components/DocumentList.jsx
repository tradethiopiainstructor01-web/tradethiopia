...
const DocumentList = () => {
    ...
    const fetchDocuments = async () => {
        try {
            const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/documents`, {
                params: { section: 'companys' }, // Add section as query parameter
            });
    ...
    const fetchCategories = async () => {
        try {
            ...
            const filteredCategories = res.data.data.filter(category => category.section === 'companys'); // Filter here
    ...
    const createCategory = async () => {
        ...
        try {
            const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/categories`, {
                ...
                section: 'companys', // Ensure this is included
            });
    ...
    const sortedCategories = [...categories].sort((a, b) => {
        ...
        return isSorted ? a.name.localeCompare(b.name) : 0;
      });
