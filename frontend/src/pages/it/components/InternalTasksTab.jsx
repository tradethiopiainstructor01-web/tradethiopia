          ...
          <CardBody>
            <Stat>
              ...
              <StatNumber fontSize="2xl" fontWeight="bold" mt={1}>
                {(tasks || []).filter(t => t.projectType === 'internal').length}
              </StatNumber>
            </Stat>
          </CardBody>
        </Card>
          ...
          <CardBody>
            <Stat>
              ...
              <StatNumber fontSize="2xl" fontWeight="bold" mt={1} color="blue.500">
                {(tasks || []).filter(t => t.projectType === 'internal' && t.status === 'ongoing').length}
              </StatNumber>
            </Stat>
          </CardBody>
        </Card>
          ...
          <CardBody>
            <Stat>
              ...
              <StatNumber fontSize="2xl" fontWeight="bold" mt={1} color="green.500">
                {(tasks || []).filter(t => t.projectType === 'internal' && t.status === 'done').length}
              </StatNumber>
            </Stat>
          </CardBody>
        </Card>
          ...
          <CardBody>
            <Stat>
              ...
              <StatNumber fontSize="2xl" fontWeight="bold" mt={1} color="red.500">
                {(tasks || []).filter(t => t.projectType === 'internal' && t.priority === 'High').length}
              </StatNumber>
            </Stat>
          </CardBody>
        </Card>
...
export default InternalTasksTab;
