  ...
  return (
    <Layout>
      ...
      <Text color="gray.600" mb={4}>
        Enter each customer service rep's target, achieved amount, and absences to see their KPI result. Save per period for later review.
      </Text>
                      ...
                      <Tr key={row.id}>
                        ...
                        <Td>
                          <HStack spacing={2}>
                            ...
                            <Tooltip
                              label={`Achievement: ${achievementPct.toFixed(1)}% | Penalty: -${attendancePenalty.toFixed(
                                1
                              )}`}
                            >
