...
const userSchema = new mongoose.Schema({
    ...
    role: {
        type: String,
        enum: ['admin', 'HR', 'sales', 'salesmanager', 'tradextv', 'customerservice', 'SocialmediaManager', 'CustomerSuccessManager', 'TETV', 'IT', 'HR', 'supervisor', 'Instructor', 'EventManager', 'COO', 'TradeXTV', 'finance'],
        default: 'sales',
        index: true, // Add index for faster queries
    },
    status: {
